...
module.exports = function($state, FlashStateModel, SelectionStateModel, AnalyticsService, SettingsModel, AppConfigService) {

  /**
   * @summary The OS selector state
   * @property
   * @type Object
   */
   ...
   *
   * @example
   * FinishController.getImageLogo();
   */
  this.getImageLogo = () => {
    if (this.selection.hasOS()) {
      return AppConfigService.getAbsolutePath(this.selection.getImageLogo());
    }
    return this.selection.getImageLogo();
  };
