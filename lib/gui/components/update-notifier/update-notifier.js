...
/**
 * @summary The update notifier sleep time
 * @constant
 * @private
 * @type {Number}
 *
 * @description
 * Seven days: 7 * 24 * 60 * 60 * 100
 */
const UPDATE_NOTIFIER_SLEEP_TIME = 64800000;

UpdateNotifier.constant('UPDATE_NOTIFIER_SLEEP_TIME', UPDATE_NOTIFIER_SLEEP_TIME);
