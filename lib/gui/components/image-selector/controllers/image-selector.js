...
module.exports = function(
   ...
   *
   * @example
   * ImageSelectorController.getSelectedBoard();
   */
  this.getSelectedBoard = () => {
    return ImageSelectorService.selectedBoard;
  };
   ...
   *
   * @example
   * ImageSelectorController.setSelectedBoard();
   */
  this.setSelectedBoard = (board) => {
    ImageSelectorService.selectedBoard = board;
  };
    ...
    $http.get(AppConfigService.BOARDS_DATA + '?d=' + new Date().getTime())
      .then((payload) => {
        ...
        if (this.getSelectedBoard()) {
          ...
          this.getBoardOSes(this.getSelectedBoard());
        } else {
