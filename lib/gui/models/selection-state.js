...
/**
 * @summary Set a OS information
 * @function
 * @public
 *
 * @param {Object} os - OS data
 *
 * @example
 * SelectionStateModel.setOS({
 *  name: 'OS name'
 *  version: 'User selected version'
 *  images: []
 ...
 */
   ...
   *
   * @example
   * const image = SelectionStateModel.getOS();
   */
  this.getOS = () => {
    return _.get(Store.getState().toJS(), 'selection.os');
  };

  /**
   * @summary Get the selected OS version
   * @function
   * @public
   *
   * @returns {String}
   *
   * @example
   * const image = SelectionStateModel.getOSVersion();
   */
  this.getOSVersion = () => {
    return _.get(Store.getState().toJS(), 'selection.os.version');
  };

  /**
   * @summary Get the smallest OS image
   * @function
   * @public
   *
   ...
   *
   * @example
   * const image = SelectionStateModel.getOSSmallestImage();
   */
  this.getOSSmallestImage = () => {
    if (this.hasOS()) {
      return _.minBy(this.getOS().images, 'recommendedDriveSize');
    }
  ...
  /**
   * @summary Get the smallest OS image size
   * @function
   * @public
   *
   ...
   *
   * @example
   * const image = SelectionStateModel.getOSMinimumImageSize();
   */
  this.getOSMinimumSize = () => {
    if (this.hasOS()) {
      return this.getOSSmallestImage().recommendedDriveSize;
    }
  ...
  /**
   * @summary Check if there is a selected OS
   * @function
   * @public
   *
   * @returns {Boolean} whether there is a selected OS
   *
   * @example
   * if (SelectionStateModel.hasOS()) {
   *   console.log('There is an OS!');
   * }
   */
  this.hasOS = () => {
    return Boolean(this.getOS());
  };
