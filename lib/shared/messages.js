...
module.exports = {
  ...
  warning: {
    ...
    exitWhileFlashing: _.template([
      ...
      'Closing PINE64 Installer may leave your drive in an unusable state.'
    ].join(' ')),
  ...
  error: {
    ...
    downloadTimeout: _.template([
      'Connection has being interrupted.',
      'Please check your network connection and try again.'
    ].join(' ')),

    checksumFail: _.template([
      'Image corrupted',
      'Please download your image again.'
    ].join(' ')),

    notEnoughDownloadSpace: _.template([
      'Not enough space on download directory.',
      'Please squeeze some space for image downloading.'
    ].join(' ')),

    genericFlashError: _.template('Oops, seems something went wrong.'),

    validation: _.template([
      'The write has been completed successfully but PINE64 Installer detected potential',
