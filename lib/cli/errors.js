...
/**
 * @summary Conn interrupt error
 * @public
 * @property
 */
exports.ConnInterruptError = typedError({
  message: 'Conn interrupt error',
  type: 'etcher',
  code: 'ECONNINTERRUPT'
});
 ...
 * @property
 */
exports.ChecksumError = typedError({
...
/**
 * @summary Download not enough space error
 * @public
 * @property
 */
exports.DownloadNoSpaceError = typedError({
  message: 'Download not enough space error',
  type: 'etcher',
  code: 'EDOWNLOADNOSPC'
});
 ...
 * @property
 */
exports.UnmountError = typedError({
